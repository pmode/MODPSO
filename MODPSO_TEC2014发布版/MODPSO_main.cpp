...
/*----------------------------unsigned real-world networks----------------------*/
  char *RealData[] = {  "RealWorld\\dFB50.txt",			"RealWorld\\25_point.txt",\
						...
						"RealWorld\\2node\\test.txt"};

/*---------------------nos. of nodes of the corresponding unsigned networks-------------------------*/
  int  nvars[]       = {50, 25, 125, 34, 62, 115, 105, 0, 118, 1589, 1461, 4941, 4941, 0, 8361, 10680,test_node};
...
//*
	int RealIndex =16; //8--SFI, 10--netremove, 12--powerremove, 3-karate,4-dolphin,5-football,16-test
...
/*------------------------------------------------------------------------------*/
	...
	{
		start = clock();
		cout<<endl<<"第 "<<mg+1<<"次运行";
		MOEAD.run(sd, niche, max_gen, rn);
		cout <<"时间："<<(double)(clock() - start) / CLOCKS_PER_SEC<<endl;
